...
<div class="min-h-screen bg-[#001220] flex flex-col items-center pt-16 pb-16 relative overflow-hidden">
    ...
    {{-- Search Bar --}}
    <form method="GET" action="{{ route('products.index') }}" class="mb-8 w-full max-w-md z-10" id="searchForm">
        <input
            type="text"
            name="search"
            value="{{ request('search') }}"
            placeholder="Search products..."
            class="w-full px-4 py-2 rounded-lg bg-white/80 border border-white/50 text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-400"
            id="searchInput"
        />
    </form>
    <script>
